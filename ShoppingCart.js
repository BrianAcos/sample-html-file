...
const drawTable = () => {
    ...
    products.forEach(product => {
        ...
        // Cuando se hace click sobre la papelera, borra el producto y recalcula los totales
...
const start = () => {
    ...
    $('#addToCartForm').submit((event) => {
        ...
        // seleccionar valores ingresados de los input
        var cantidad = document.querySelector('#quantity').value;
        var nombre = document.querySelector('#productName').value;
        var precio = document.querySelector('#unitPrice').value;
        //agregar un producto a el carrito con los valores ingresados
        products.push({
            name: nombre,
            price: precio,
            quantity: cantidad
        });
        // dibujar la tabla y los totales
        drawTable();
        drawTotals();
